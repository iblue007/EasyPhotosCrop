...
//        Uri uri = UriUtils.getUriByPath(context, uri11.toString());
        Log.e("======", "======uri2222:" + uri.toString());
        ...
        try {
            ...
            if (VersionUtils.isAndroidQ()) {
                ...
                pathName = UriUtils.getRealPathFromUri(context, uri);
                exifInterface = new ExifInterface(pathName);
                Log.e("======", "======uri2222pathName:" + pathName);
            }
